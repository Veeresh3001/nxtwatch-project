        ...
        return (
          ...
          >
            <GamingCard darkMode={darkMode}>
              ...
              <p className='gaming-p1'>{item.title}</p>
              <p className='gaming-p2'>{item.viewCount} views</p>
            </GamingCard>
          </Link>
        )
      }}
      ...
      <>
        ...
        <GamingList>
          {gamingVideosList.map(each => (
            <li className='gaming-item' key={each.id}>{this.trendingVideoItem(each, darkMode)}</li>
          ))}
        </GamingList>
      </>
    )
